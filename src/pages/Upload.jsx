...
const UploadPage = () => {
  ...
  const handleConnectDB = () => {
    ...
    console.log('Connect to DB'); // Replace with actual database connection logic
  };

  const handleNext = () => {
    // Navigate to the next page (could be a preview page or model selection page)
    navigate('/preview');
  };
    ...
    <>
      ...
      >
        ...
        <div className="relative bg-white rounded-lg shadow-lg p-8 max-w-lg w-full z-10">
          ...
          {/* Connect DB Button */}
          <button
            className="w-full mt-6 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 px-4 rounded-lg focus:outline-none transition duration-200"
