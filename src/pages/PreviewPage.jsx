  ...
  return (
    <div className="h-screen w-full bg-white p-8">
      ...
      <div className="mt-6 text-center">
        <Link to="/model" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
          Next 
        </Link>
      </div>
    </div>
